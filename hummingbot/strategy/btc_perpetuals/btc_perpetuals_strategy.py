from hummingbot.strategy.btc_perpetuals.agents.ema_calculator import EMACalculator
from hummingbot.strategy.btc_perpetuals.agents.vwap_calculator import VWAPCalculator
from hummingbot.strategy.btc_perpetuals.agents.order_flow_analyzer import OrderFlowAnalyzer
from hummingbot.strategy.btc_perpetuals.agents.garch_model import GARCHModel
from hummingbot.strategy.btc_perpetuals.agents.execution_manager import ExecutionManager
from hummingbot.strategy.btc_perpetuals.agents.position_manager import PositionManager
from hummingbot.strategy.btc_perpetuals.agents.risk_evaluator import RiskEvaluator

class BTCPerpetualsStrategy:
    """
    Main strategy logic for BTC Perpetuals.
